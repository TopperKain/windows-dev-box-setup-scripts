...
function Install-VSIXExtensionTK{
 param( [string]$extensionName )
 
Write-Host "Installing $extensionName" -ForegroundColor "Yellow"
$requestUri = "https://marketplace.visualstudio.com/_apis/public/gallery/extensionquery";
$requestBody = '{"flags":"262","filters":[{"criteria":[{"filterType":"10","value":"$extensionName"}],"sortBy":"0","sortOrder":"2","pageSize":"25","pageNumber":"1"}]}';
...
$vsixInstallerFile = Get-Childitem -Include vsixinstaller.exe -Recurse -Path "C:\Program Files (x86)\Microsoft Visual Studio\Installer\";
...
Install-VSIXExtensionTK --extensionName "StyleCop"

Install-VSIXExtensionTK "Web Essentials 2019"
